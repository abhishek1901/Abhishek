...
def create_mosaic():
    ...
    Mosaic_btn_manual.place(relx = 0.16, rely = 0.25)
    ...
    Mosaic_btn_auto.place(relx = 0.1, rely = 0.55)
...
#label=tk.Label(frame,text='---------Filters---------',fg='black',bg='#EFF294',font=('Bauhaus 93',20))
...
TakePhoto_btn = tk.Button(canvas,text = 'Take A Photo',fg = '#0b6623',padx = 10,pady = 5,font=('Bauhaus 93',14), command = webcam)
